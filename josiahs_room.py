 ...
 /__\               /__\ /__\               /__\ /__\               /__\   
        ...
        while valid_choice:
            ...
            if mirror_choice == '1':
                ...
                print(
                    "Yikes. Apologies, but that's not an option. Let's try that again, I know you can do it champ!")
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢑⢸⢌⢖⢠⢀⠪⡂
    ...
    def monster_ending(self):
        ...
        continue_prompt = input(
            "Though you were met with a tragic end, this doesn't have to be the end of this story:\n(1) To go back to your mirror choice\n(2) To go back to the room selections\n> ")
