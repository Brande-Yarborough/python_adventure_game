...
/____\             /____\  
        ...
        """)
        print("\nA mirror appears before you and you approach it. You reach out to touch it and when your hand touches the one of your reflection, you fall through the veneer.")
        print("Your eyes open and you find yourself in a dark room. No, room isn't quite the right word.-PAUSE-. Formless void? Yes! A perfectly apt description, a formless void. Curiously, your apocryphal alabastrine escort with an eye for fashionable yet functional wristwear seems to be missing.")
